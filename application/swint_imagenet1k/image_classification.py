    ...
    prepare_custom_config_dict = {
        ...
        'extra_qconfig_dict': {
            ...
            'int4_op': [
                ...
                'view_3_post_act_fake_quantizer', 
                'view_17_post_act_fake_quantizer',
                'view_38_post_act_fake_quantizer',
                'view_52_post_act_fake_quantizer',
                'view_73_post_act_fake_quantizer',
                'view_87_post_act_fake_quantizer',
                'view_106_post_act_fake_quantizer',
                'view_120_post_act_fake_quantizer',
                'view_139_post_act_fake_quantizer',
                'view_153_post_act_fake_quantizer',
                'view_174_post_act_fake_quantizer',
                'view_188_post_act_fake_quantizer', 
            ],
            'int4_module_weight': [
                'swin.encoder.layers.0.blocks.0.attention.self.query', 'swin.encoder.layers.0.blocks.0.attention.self.key', 'swin.encoder.layers.0.blocks.0.attention.self.value',
                'swin.encoder.layers.0.blocks.1.attention.self.query', 'swin.encoder.layers.0.blocks.1.attention.self.key', 'swin.encoder.layers.0.blocks.1.attention.self.value',
                'swin.encoder.layers.1.blocks.0.attention.self.query', 'swin.encoder.layers.1.blocks.0.attention.self.key', 'swin.encoder.layers.1.blocks.0.attention.self.value',
                'swin.encoder.layers.1.blocks.1.attention.self.query', 'swin.encoder.layers.1.blocks.1.attention.self.key', 'swin.encoder.layers.1.blocks.1.attention.self.value',
                'swin.encoder.layers.2.blocks.0.attention.self.query', 'swin.encoder.layers.2.blocks.0.attention.self.key', 'swin.encoder.layers.2.blocks.0.attention.self.value',
                'swin.encoder.layers.2.blocks.1.attention.self.query', 'swin.encoder.layers.2.blocks.1.attention.self.key', 'swin.encoder.layers.2.blocks.1.attention.self.value',
                'swin.encoder.layers.2.blocks.2.attention.self.query', 'swin.encoder.layers.2.blocks.2.attention.self.key', 'swin.encoder.layers.2.blocks.2.attention.self.value',
                'swin.encoder.layers.2.blocks.3.attention.self.query', 'swin.encoder.layers.2.blocks.3.attention.self.key', 'swin.encoder.layers.2.blocks.3.attention.self.value',
                'swin.encoder.layers.2.blocks.4.attention.self.query', 'swin.encoder.layers.2.blocks.4.attention.self.key', 'swin.encoder.layers.2.blocks.4.attention.self.value',
                'swin.encoder.layers.2.blocks.5.attention.self.query', 'swin.encoder.layers.2.blocks.5.attention.self.key', 'swin.encoder.layers.2.blocks.5.attention.self.value',
                'swin.encoder.layers.3.blocks.0.attention.self.query', 'swin.encoder.layers.3.blocks.0.attention.self.key', 'swin.encoder.layers.3.blocks.0.attention.self.value',
                'swin.encoder.layers.3.blocks.1.attention.self.query', 'swin.encoder.layers.3.blocks.1.attention.self.key', 'swin.encoder.layers.3.blocks.1.attention.self.value',
            ],
        },
